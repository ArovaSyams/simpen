const addALokasiModal = document.getElementById('addALokasiModal');
const closeALokasiBtn = document.getElementById('closeALokasiModal');
const addALokasiBtn = document.getElementById('addALokasiBtn');


addAlokasiBtn.onclick = function () {
  addAlokasiModal.classList.toggle('hidden');
}
closeAlokasiBtn.onclick = function () {
  addAlokasiModal.classList.toggle('hidden');
}
